...
int main(void)
{
  ...
  Lcd_PortType ports[] = { GPIOA, GPIOA, GPIOA, GPIOA };
      ...
      Lcd_cursor(&lcd, 0,1);
      Lcd_string(&lcd, "Janani");
      Lcd_cursor(&lcd, 1,1);
      Lcd_string(&lcd, "212223230086");
...
## Output screen shots of proteus  :
 ...
 ![pmc 1](https://github.com/user-attachments/assets/008c35f7-160f-4ff9-a170-0a88abd5dc46)

 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 
 ![image](https://github.com/user-attachments/assets/86a74e07-0b1b-4847-8e03-9e2895b9240d)
